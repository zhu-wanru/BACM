...
class Dataset(torch.utils.data.Dataset):
    ...
    def collate_fn(self, items):
        ...
        return {'locs': locs, 'voxel_locs': voxel_locs, 'p2v_map': p2v_map, 'v2p_map': v2p_map, 'locs_float': locs_float,'feats': feats, 'labels': labels, 
                'offsets': batch_offsets, 'spatial_shape': spatial_shape, 'id': ids, 'selected_idx': selected_idx, 'mix_idx': mix_idx, 'mask1': mask1, 
                'mask2': mask2, 'tar_tail_splits': tar_tail_splits, 'tar_splits_class_ratio': tar_splits_class_ratio}
    ...
    def test_collate_fn(self, items):
        ...
        return {'locs': locs, 'voxel_locs': voxel_locs, 'p2v_map': p2v_map, 'v2p_map': v2p_map, 'locs_float': locs_float, 'feats': feats, 'labels': labels,
                'offsets': batch_offsets, 'spatial_shape': spatial_shape, 'id': ids}
