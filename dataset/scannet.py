...
#     with open('/cluster/personal/GSAM_seg/cfgs/dataset_cfgs/scannet/scannet_cfg.yaml', 'r') as f:
#         try:
...
#     train_dataset = ScanNetDataset(cfg, None, None)
